...
# creating the directory called trimmed and sub-directories paired and un-paired
...
function trim {
    ...
    data/trimmed/unpaired/Aip02.R1.unpaired.fastq \
    data/trimmed/paired/Aip02.R2.paired.fastq \
    data/trimmed/unpaired/Aip02.R2.unpaired.fastq \
    HEADCROP:0 \
